...
import static com.accor.wcp.services.auditstream.notification.es.manager.opensearch.OpensearchHelper.*;
...
public class IndexCreationClient {
    ...
    public String getWriteAliasFor(String domain, String indexSuffix, String env, int ttl, String indexMappingFile) {
    ...
    @SneakyThrows
    public GetComposableIndexTemplatesResponse getIndexTemplate(String indexTemplateName) {
    ...
    private void createIndexTemplate(String indexPrefix, String aliasWrite, String aliasRead, String indexMappingFile) {
        ...
        if (nonNull(actualIndexTemplate)
                && actualIndexTemplate
                .getIndexTemplates()
                .get(templateName)
                .version()
                .equals(INDEX_TEMPLATE_VERSION)) {
            log.info(
    ...
    private void createLifecyclePolicy(String indexPrefix, int ttl) {
        ...
        String policyTemplate = new String(this.getClass().getResourceAsStream("/opensearch/audit_policy.json").readAllBytes(),
    ...
    @SneakyThrows
    public boolean checkAliasExist(String alias) {
