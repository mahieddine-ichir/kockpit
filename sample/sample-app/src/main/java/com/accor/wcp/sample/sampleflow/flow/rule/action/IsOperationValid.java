...
@Component
public class IsOperationValid implements Predicate<FlowContextContainer> {
    ...
    public boolean test(FlowContextContainer flowContext) {
        ...
        return context.getInputOp().equals("*") || context.getInputOp().equals("+") || context.getInputOp().equals("-") ;
    }
}
