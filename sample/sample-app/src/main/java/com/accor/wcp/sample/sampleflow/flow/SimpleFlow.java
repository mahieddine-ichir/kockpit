...
import static com.accor.wcp.sample.sampleflow.flow.rule.BusinessRule.*;
...
public class SimpleFlow implements Flow {
    ...
    public List<FlowEntry> getEntries() {
        return Arrays.asList(
                ...
                new DefaultFlowEntry(BR_WILL_SAY_HELLO_TO_USER_WITH_EXCLAMATION_MARK_ANOTHER_RULE2.name()),
                new DefaultFlowEntry(BR_WILL_SAY_HELLO_TO_USER_WITH_EXCLAMATION_MARK_SIMPLE_RULE2.name())
        );
    }
}
