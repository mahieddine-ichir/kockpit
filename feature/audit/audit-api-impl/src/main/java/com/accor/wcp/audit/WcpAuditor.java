...
import static com.accor.wcp.audit.WcpAuditorEvent.closeCurrentAuditEvents;
import static com.accor.wcp.audit.WcpAuditorKeyValue.closeCurrentAuditIndexedKeyValues;
...
@Slf4j
class WcpAuditor implements AuditorService {
