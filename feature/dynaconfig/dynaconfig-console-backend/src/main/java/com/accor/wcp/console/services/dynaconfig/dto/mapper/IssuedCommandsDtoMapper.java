...
import com.accor.wcp.console.services.dynaconfig.dto.IssuedCommandDto;
import com.accor.wcp.console.services.dynaconfig.dto.RequestIssuedCommandDto;
import com.accor.wcp.console.services.dynaconfig.dto.ResponseIssuedCommandDto;
...
public interface IssuedCommandsDtoMapper {

  default List<IssuedCommandDto> mapAllCommands(List<DynaConfigRequest> requests) {
  ...
  default List<RequestIssuedCommandDto> mapRequest(DynaConfigRequest request) {
  ...
  ResponseIssuedCommandDto mapResponse(DynaConfigResponse response);

  default List<ResponseIssuedCommandDto> mapResponses(List<DynaConfigRequest> requests) {
    return requests.stream()
        .map(DynaConfigRequest::getResponses)
