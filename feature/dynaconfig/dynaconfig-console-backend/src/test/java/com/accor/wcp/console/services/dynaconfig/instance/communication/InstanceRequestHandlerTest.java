...
class InstanceRequestHandlerTest {
  ...
  InstanceRequestHandler underTest;
  ...
  void setup() {
    ...
    this.underTest = new InstanceRequestHandler(this.communicationService);
  }

  @Test
  void should_return_id_and_add_to_requests() {
    when(this.communicationService.broadcast(
            eq("dynaconfig"), eq("domainTest"), eq("envTest"), eq("applicationIdTest"), any()))
        .thenReturn("idtest");
    ...
    DynaConfigRequest dynaConfigRequest =
    ...
    assertThat(this.underTest.getRequests("domainTest", "envTest", "applicationIdTest").size())
        .isEqualTo(1);
    assertThat(dynaConfigRequest.getRequestId()).isEqualTo("idtest");
    assertThat(dynaConfigRequest.getDomain()).isEqualTo("domainTest");
    assertThat(dynaConfigRequest.getEnv()).isEqualTo("envTest");
    assertThat(dynaConfigRequest.getAppId()).isEqualTo("applicationIdTest");
    assertThat(dynaConfigRequest.getInstanceId()).isNull();

    assertThat(dynaConfigRequest.getMessages().size()).isEqualTo(1);
    assertThat(dynaConfigRequest.getMessages().get(0).getPropertyName()).isEqualTo("propKey");
    assertThat(dynaConfigRequest.getMessages().get(0).getNewValue()).isEqualTo("propValue");
  ...
  void shouldReturnIdTestWhenBroadCastMultiUpdatesRequest() {
    ...
    assertThat(dynaConfigRequest.getMessages().size()).isEqualTo(2);

    assertThat(dynaConfigRequest.getMessages().get(0).getPropertyName()).isEqualTo("prop2");
    assertThat(dynaConfigRequest.getMessages().get(0).getNewValue()).isEqualTo("value2");

    assertThat(dynaConfigRequest.getMessages().get(1).getPropertyName()).isEqualTo("prop1");
    assertThat(dynaConfigRequest.getMessages().get(1).getNewValue()).isEqualTo("value1");
  ...
  void should_add_to_request_response() {
    ...
    DynaConfigResponse response =
        DynaConfigResponse.builder()
