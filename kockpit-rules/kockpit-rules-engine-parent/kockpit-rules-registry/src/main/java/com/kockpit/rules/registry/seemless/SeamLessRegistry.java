package com.kockpit.rules.registry.seemless;
...
import com.kockpit.rules.registry.*;
...
import com.kockpit.rules.registry.seemless.json.FlowJson;
import com.kockpit.rules.registry.seemless.json.KEngineJSon;
import com.kockpit.rules.registry.seemless.json.RuleJson;
import com.kockpit.rules.seemless.Flow;
import com.kockpit.rules.seemless.Rule;
...
public class SeamLessRegistry extends RuleNodeRegistry {
  ...
  private List<com.kockpit.rules.registry.model.Flow> oldCompatibilityFlows;
  ...
  private Map<String, com.kockpit.rules.registry.model.Rule> ruleById;

  private Map<String, List<com.kockpit.rules.registry.model.Rule>> flowRulesByFlowId;

  private RegistryImpl currentRegistry;
  private List<com.kockpit.rules.registry.model.Flow> flows;
  ...
  private void computeRulesBys() {
    ruleById =
        rules.stream().collect(toMap(com.kockpit.rules.registry.model.Rule::getId, identity()));
  ...
  private void compute(Collection<com.kockpit.rules.registry.model.Flow> flows) {
  ...
  private com.kockpit.rules.registry.model.Flow convertToFlowModel(
  ...
  private com.kockpit.rules.registry.model.Flow convertToFlowModel(FlowJson flowJson) {
    return new SeamLessFlow(flowJson);
  }

  private Map<String, List<com.kockpit.rules.registry.model.Rule>> newComputeRulesByFlowId(
      Collection<com.kockpit.rules.registry.model.Flow> flows1) {
    return flows1.stream()
        .map(this::getRulesListByFlow)
        .collect(toMap(Entry::getKey, Entry::getValue));
  }

  private SimpleEntry<String, List<com.kockpit.rules.registry.model.Rule>> getRulesListByFlow(
      com.kockpit.rules.registry.model.Flow flow) {
    List<com.kockpit.rules.registry.model.Rule> rules =
        flow.getEntries().stream().map(this::findRule).toList();
    return new SimpleEntry<>(flow.getId(), rules);
  }

  private com.kockpit.rules.registry.model.Rule findRule(FlowEntry flowEntry) {
    String entryId = flowEntry.getEntryId();
    com.kockpit.rules.registry.model.Rule rule = ruleById.get(entryId);
    if (isNull(rule)) {
  ...
  protected RegistryImpl computeCurrentRegistry() throws JsonProcessingException {
    ...
    Optional<List<com.kockpit.rules.registry.model.Flow>> flows = getFlows();
    if (flows.isPresent()) {
  ...
  @Deprecated
  @Override
  public Optional<List<com.kockpit.rules.registry.model.Flow>> getFlows() {
    return Optional.of(this.flows);
  }

  @Deprecated
  @Override
  public List<com.kockpit.rules.registry.model.Rule> getRules() {
    return new ArrayList<>(rules);
  }

  public List<com.kockpit.rules.registry.model.Rule> getRulesByFlowId(String id) {
...
@Data
@Slf4j
class SeamLessFlow implements com.kockpit.rules.registry.model.Flow {
