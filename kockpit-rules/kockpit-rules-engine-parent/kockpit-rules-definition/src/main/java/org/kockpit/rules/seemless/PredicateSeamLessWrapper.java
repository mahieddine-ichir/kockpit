...
class PredicateSeamLessWrapper implements Predicate<Object> {
  ...
  private DynamicEndpointHelper.DynamicEndpoint<org.kockpit.rules.seemless.Predicate>
      dynamicEndpoint;
  ...
  private void computeDocumentation() {
    ...
    org.kockpit.rules.seemless.Predicate predicateAnnotation = dynamicEndpoint.getAnnotation();
  ...
  private void computeDynamicEndpointMetadata() {
    dynamicEndpoint = readDynamicEndpoint(predicate, org.kockpit.rules.seemless.Predicate.class);
  }
