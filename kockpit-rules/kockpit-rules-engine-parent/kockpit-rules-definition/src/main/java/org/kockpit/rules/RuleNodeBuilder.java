...
import org.kockpit.rules.action.ActionWithDocumentationWrapper;
import org.kockpit.rules.action.ExitSilentlyAction;
import org.kockpit.rules.action.ExitWithErrorAction;
import org.kockpit.rules.predicate.AlwaysTruePredicate;
...
public class RuleNodeBuilder<T> {
  ...
  private final Predicate<T> eligibilityPredicate;
  ...
  public RuleNodeBuilder<T> predicate(Predicate<T> predicate) {
  ...
  public RuleNodeBuilder<T> action(Action<T> action) {
