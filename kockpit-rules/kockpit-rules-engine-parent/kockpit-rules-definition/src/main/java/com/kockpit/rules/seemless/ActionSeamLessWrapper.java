...
class ActionSeamLessWrapper implements Action<Object> {
  ...
  private DynamicEndpointHelper.DynamicEndpoint<com.kockpit.rules.seemless.Action> dynamicEndpoint;
  ...
  private void computeDocumentation() {
    ...
    com.kockpit.rules.seemless.Action actionAnnotation = dynamicEndpoint.getAnnotation();
  ...
  private void computeDynamicEndpointMetadata() {
    dynamicEndpoint =
        readDynamicEndpoint(action, methodSignature, com.kockpit.rules.seemless.Action.class);
  }
