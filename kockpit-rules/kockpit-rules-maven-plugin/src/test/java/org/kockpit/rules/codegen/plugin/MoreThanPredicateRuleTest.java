...
class MoreThanPredicateRuleTest {

    @Test
    void execute() {
        CodeGenMojo codeGenMojo = new CodeGenMojo();
        codeGenMojo.setOutputDirectory("/generated-test-sources/kockpit/src/test/java");
        codeGenMojo.setInputSpec("src/test/resources/rule-with-more-than-one-predicate.json");
        codeGenMojo.setPackageName("com.kockpit.rules.complex");
