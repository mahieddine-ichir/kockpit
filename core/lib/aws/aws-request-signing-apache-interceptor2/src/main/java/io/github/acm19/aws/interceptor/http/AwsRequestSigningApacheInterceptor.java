 ...
 * region using an AWS {@link Signer} and {@link AwsCredentialsProvider}.
 */
...
public final class AwsRequestSigningApacheInterceptor implements HttpRequestInterceptor {
   ...
   */
  public AwsRequestSigningApacheInterceptor(
      String service, Signer signer, AwsCredentialsProvider awsCredentialsProvider, String region) {
